...
<body>
  ...
  <h2 style="text-align: center;"><u>Form</u></h2>
    
    <form id="invoiceForm" action="{{route('do_form')}}" method="POST" enctype="multipart/form-data">
        @csrf
    ...
    <div>
        ...
        <select id="taxPercentage" name="taxPercentage" class="form-select">
    ...
    <div>
        ...
        <input type="text" id="netAmount" name="netAmount" class="form-control" readonly>
    </div>
    <div>
        <label for="customerName">Customer Name:</label>
        <input type="text" id="customerName" name="customerName" pattern="[A-Za-z ]+" class="form-control" required>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="file" id="fileUpload" name="photo" accept=".jpg, .png, .pdf" class="form-control" required>
    </div>
    <div>
